...
public class MatriculaXDataUnicaExtractor {
	...
	public MatriculaXDataUnicaExtractor() {
		this.matriculaXDataUnicaKeys = new ArrayList<>();
		this.matriculaXDataUnicaResults = new ArrayList<>();
		this.columnKeys = new HashMap<String, Integer>();
	}
	...
	private void checkDatesAndIDs(List<Path> paths) {
		...
		for (Path path : paths) {
			...
			this.matriculaXDataUnicaResults.add(
					this.extractInfo(
					this.filterKeys(path.toFile(), fileName), fileName));
